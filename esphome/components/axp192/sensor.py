...
from esphome.const import CONF_ID,\
    CONF_BATTERY_LEVEL, CONF_BRIGHTNESS, UNIT_PERCENT, ICON_BATTERY, DEVICE_CLASS_BATTERY
...
batt_schema = sensor.sensor_schema(UNIT_PERCENT, ICON_BATTERY, 1, DEVICE_CLASS_BATTERY)


CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(AXP192Component),
    cv.Optional(CONF_BATTERY_LEVEL): batt_schema,
